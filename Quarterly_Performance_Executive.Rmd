...
# Referrals Tables -------------------------------------------------------------
monthly_referral_vol <- readRDS("C:/Users/kweons01/Desktop/Strategic Initiatives - So Youn/Github/quarterly-processing/Quarterly_Data/Quarterly_Data/monthly_referral_vol.rds")


# Volume Tables ----------------------------------------------------------------
## Arrived monthly volume ======================================================
monthly_vol <- readRDS("C:/Users/kweons01/Desktop/Strategic Initiatives - So Youn/Github/quarterly-processing/Quarterly_Data/Quarterly_Data/monthly_vol.rds")
## Arrived Epic department quarterly volume ====================================
vol_zip_code <- readRDS("C:/Users/kweons01/Desktop/Strategic Initiatives - So Youn/Github/quarterly-processing/Quarterly_Data/Quarterly_Data/vol_zip_code.rds")

# Access Tables ----------------------------------------------------------------
## Wait Time Horizon by Specialty ==============================================
waitTime_dist_specialty <- readRDS("C:/Users/kweons01/Desktop/Strategic Initiatives - So Youn/Github/quarterly-processing/Quarterly_Data/Quarterly_Data/waitTime_dist_specialty.rds")
waitTime_dist_site <- readRDS("C:/Users/kweons01/Desktop/Strategic Initiatives - So Youn/Github/quarterly-processing/Quarterly_Data/Quarterly_Data/waitTime_dist_site.rds")
                                   
## Median Wait Time ============================================================
waitTime_mshs <- readRDS("C:/Users/kweons01/Desktop/Strategic Initiatives - So Youn/Github/quarterly-processing/Quarterly_Data/Quarterly_Data/waitTime_mshs.rds")
waitTime_site <- readRDS("C:/Users/kweons01/Desktop/Strategic Initiatives - So Youn/Github/quarterly-processing/Quarterly_Data/Quarterly_Data/waitTime_site.rds")
waitTime_prov <- readRDS("C:/Users/kweons01/Desktop/Strategic Initiatives - So Youn/Github/quarterly-processing/Quarterly_Data/Quarterly_Data/waitTime_prov.rds")

# Payor Mix Table --------------------------------------------------------------
payer_mix_quarter_site <- readRDS("C:/Users/kweons01/Desktop/Strategic Initiatives - So Youn/Github/quarterly-processing/Quarterly_Data/Quarterly_Data/payer_mix_quarter_site.rds")


## Arrived monthly volume ======================================================
monthly_vol_office <- readRDS("C:/Users/kweons01/Desktop/Strategic Initiatives - So Youn/Github/quarterly-processing/Quarterly_Data/Quarterly_Data/monthly_vol_office.rds")
## Arrived Epic department quarterly volume ====================================
vol_zip_code_office <- readRDS("C:/Users/kweons01/Desktop/Strategic Initiatives - So Youn/Github/quarterly-processing/Quarterly_Data/Quarterly_Data/vol_zip_code_office.rds")

# Access Tables ----------------------------------------------------------------
## Wait Time Horizon by Specialty ==============================================
waitTime_dist_specialty_office <- readRDS("C:/Users/kweons01/Desktop/Strategic Initiatives - So Youn/Github/quarterly-processing/Quarterly_Data/Quarterly_Data/waitTime_dist_specialty_office.rds")
waitTime_dist_site_office <- readRDS("C:/Users/kweons01/Desktop/Strategic Initiatives - So Youn/Github/quarterly-processing/Quarterly_Data/Quarterly_Data/waitTime_dist_site_office.rds")
                                   
## Median Wait Time ============================================================
waitTime_mshs_office <- readRDS("C:/Users/kweons01/Desktop/Strategic Initiatives - So Youn/Github/quarterly-processing/Quarterly_Data/Quarterly_Data/waitTime_mshs_office.rds")
waitTime_site_office <- readRDS("C:/Users/kweons01/Desktop/Strategic Initiatives - So Youn/Github/quarterly-processing/Quarterly_Data/Quarterly_Data/waitTime_site_office.rds")
waitTime_prov_office <- readRDS("C:/Users/kweons01/Desktop/Strategic Initiatives - So Youn/Github/quarterly-processing/Quarterly_Data/Quarterly_Data/waitTime_prov_office.rds")

# Payor Mix Table --------------------------------------------------------------
payer_mix_quarter_site_office <- readRDS("C:/Users/kweons01/Desktop/Strategic Initiatives - So Youn/Github/quarterly-processing/Quarterly_Data/Quarterly_Data/payer_mix_quarter_site_office.rds")
...
inc_sites <- c("NYEE", "MSB","NETWORK","MSM","MSH-MSDFP","ONCOLOGY","MSW","MSBI","MSUS","MSH- AMBULATORY CARE","MSDD")
...
key_specialties <- c("Cardiovascular Institute/Cardiology", "Medicine - Endocrinology", "Medicine - Gastroenterology",
                     ...
                     "Otolaryngology - Audiology", "Otolaryngology - ENT", "Otolaryngology - OMS", 
 ...
 # Median Time to New Appointment
  ...
  vol_var_mshs_overview <- monthly_vol %>%
   ...
   # Referrals Conversion Rate
    ...
    nms <- c("Specialty", "Received.YearQtr", "Campus", "Total", "Closed", "Arrived", "No Show", "Canceled", "Scheduled", "Pending", "Conversion Rate", "Completion Rate")
  Missing <- setdiff(nms, names(conversion_rate_mshs_overview))  # Find names of missing columns
  conversion_rate_mshs_overview[Missing] <- 0                    # Add them, filled with '0's
  conversion_rate_mshs_overview <- conversion_rate_mshs_overview[nms]
  
  conversion_rate_mshs_overview <- conversion_rate_mshs_overview %>%
    ...
    dplyr::select(Specialty, Received.YearQtr, Campus,`Conversion Rate`) 
    ...
    nms <- c("Specialty", "Received.YearQtr", "Campus", "Total", "Closed", "Arrived", "No Show", "Canceled", "Scheduled", "Pending", "Conversion Rate", "Completion Rate")
  Missing <- setdiff(nms, names(conversion_rate_site_overview))  # Find names of missing columns
  conversion_rate_site_overview[Missing] <- 0                    # Add them, filled with '0's
  conversion_rate_site_overview <- conversion_rate_site_overview[nms]
  
  conversion_rate_site_overview <- conversion_rate_site_overview %>%
    mutate(Total = rowSums(across(where(is.numeric)))) %>%
    mutate(Closed = Total - Pending) %>%
    mutate(`Conversion Rate` = round((Total - Pending)/Total,2)*100,
           `Completion Rate` = round(Arrived/Total,2)*100) %>%
...
key_specialty_site_graph <- function(index){
  # specialty <- "Dermatology"
  # index <- 1
    
    metrics_tbl <- metrics_overview_site %>%
      filter(Specialty %in% key_specialties) %>%
      filter(Specialty %in% (metrics_site_tbl_key[index, c("Specialty")])$Specialty) %>%
      filter(Campus %in% (metrics_site_tbl_key[index, c("Campus")])$Campus) %>%
  ...
  access_graph <- 
    highchart() %>%
      ...
      hc_subtitle(text = paste0((metrics_site_tbl_key[index, c("Campus")])$Campus," ", 
                             (metrics_site_tbl_key[index, c("Specialty")])$Specialty),
...
# Median Wait Time vs. % Patients Scheduled <=14 Days
other_specialty_site_graph <- function(index){
  # specialty <- "Dermatology"
  # index <- 10
  
    metrics_tbl <- metrics_overview_site %>%
      filter(Specialty %!in% key_specialties) %>%
      filter(Specialty %in% (metrics_site_tbl_other[index, c("Specialty")])$Specialty) %>%
      filter(Campus %in% (metrics_site_tbl_other[index, c("Campus")])$Campus) %>%
      mutate(new_perc = new_perc*100,
             p50 = p50*100,
             p75 = p75*100)
  ...
  access_graph <- 
    highchart() %>%
      ...
      hc_title(text = "New Patient Access", align = "left", 
           style = list(fontWeight = 'bold', fontSize = "22px", fontFamily = "Calibri")) %>%
      hc_subtitle(text = paste0((metrics_site_tbl_other[index, c("Campus")])$Campus," ", 
                             (metrics_site_tbl_other[index, c("Specialty")])$Specialty),
                  align = "left", style = list(fontFace = "italic", fontSize = "18px", fontFamily = "Calibri")) %>%
      hc_tooltip(shared = TRUE, borderColor = "black")
...
# Median Time to New Appointment
  ...
  vol_var_tbl <- vol_var_overview %>%
   ...
   conversion_rate_tbl <- conversion_rate_overview %>%
    ...
    metrics_site_tbl <- metrics_site_tbl %>%
      ...
      arrange(Specialty) %>%
      mutate(Campus = factor(Campus, levels = c("MSHS*", "MSB", "MSBI", "MSDD", "MSH- AMBULATORY CARE",
                                                "MSH-MSDFP", "MSM", "MSUS", "MSW", "NETWORK", "NYEE","ONCOLOGY"))) 
    
    metrics_site_tbl_key <-  metrics_site_tbl %>%
      filter(Specialty %in% key_specialties)

    metrics_site_tbl_other <-  metrics_site_tbl %>%
      filter(Specialty %!in% key_specialties)
  ...
  reactable(
    ...
    htmltools::div(
      h2("Trends"),
      key_specialty_site_graph(index),
      h2(" ")    )
    } # Close details
...
```{r}
  ...
  reactable(
    ...
    `Conversion Rate` = colDef(
     ...
     p50 = colDef(
      paste0("% Providers Above P50 (",min_month,"-",max_month," Annualized"),
      minWidth = 100,
      headerStyle = list(background = "#d80b8c", color = "white"),
      format = colFormat(percent = TRUE, digits = 0),
      cell = function(value) {
      ...
      style = list(fontWeight = 600, borderLeft = "1.5px solid rgb(184,184,184)")
      # style = function(value) {
      #   color <- if (is.na(value)) {"#aaa"}
      #   else if (value >= .80) {
      #     "#008000"
    ...
    align = "left"),
    p75 = colDef(
      paste0("% Providers Above P75 (",min_month,"-",max_month," Annualized"),
      minWidth = 100,
      headerStyle = list(background = "#d80b8c", color = "white"),
      format = colFormat(percent = TRUE, digits = 0),
      cell = function(value) {
    ...
    htmltools::div(
      h2("Trends"),
      other_specialty_site_graph(index),
      h2(" ")    )
    } # Close details
...
<!-- ## `r reporting_YearQtr` Overview Detail -->
<!-- <span style='font-size: 20px;'>`r reporting_YearQtr` Metrics by Specialty and Site</span><br/> -->
<!-- ```{r Metrics Overview Detail by Site Table Output, echo = FALSE, warning = FALSE, message = FALSE} -->
...
<!--     colGroup(name = "Referrals", columns = c("Conversion Rate"), -->
<!--              headerStyle = list(background = "#d80b8c", color = "white", fontSize = "15px")), -->
<!--     colGroup(name = "Productivity", columns = c("p50","p75"), -->
<!--              headerStyle = list(background = "#d80b8c", color = "white", fontSize = "15px")), -->
<!--     colGroup(name = "Space Utilization", columns = c("Space_Turn", "Space_Duration"), -->
<!--              headerStyle = list(background = "#d80b8c", color = "white", fontSize = "15px")) -->
...
<!--       # ) -->
<!--     ), -->
<!--     med_wait_change = colDef(cell = function(value) { -->
<!--       color <- switch( -->
<!--         value, -->
<!--        Improved = "hsl(120, 60%, 50%)", -->
<!--         `No Change` = "hsl(48, 100%, 50%)", -->
<!--         `Not Improved` = "hsl(0, 100%, 50%)" -->
<!--       ) -->
<!--       badge <- status_badge(color = color) -->
<!--       tagList(badge, if (is.na(value)) "  \u2013 " else value) -->
<!--     }, -->
<!--     name = "New Wait Time Compared to Last Quarter", -->
<!--     minWidth = 150,  -->
...
<!--       # ) -->
<!--     ), -->
<!--     new_perc_change =  colDef(cell = function(value) { -->
<!--       color <- switch( -->
<!--         value, -->
<!--         Improved = "hsl(120, 60%, 50%)", -->
<!--         `No Change` = "hsl(48, 100%, 50%)", -->
...
<!--       tagList(badge, if (is.na(value)) "  \u2013 " else value) -->
<!--     }, -->
<!--     name = "% New Patients Scheduled <=14 Days Compared to Last Quarter", -->
<!--     minWidth = 150,  -->
<!--     headerStyle = list(background = "#c7c6ef", color = "black", align = "center"), -->
<!--     align = "left"), -->
<!--     `var_last_qrt` = colDef( -->
...
```{r Metrics Overview by Specialty Table Output, echo = FALSE, warning = FALSE, message = FALSE}

metrics_specialty_tbl_function <- function(specialty) {
  
  # Traffic Lights for Comparison to Last Quarter Access Metrics
  library(htmltools)
  status_badge <- function(color = "#aaa", width = "0.90rem", height = width) {
    span(style = list(
      display = "inline-block",
      marginRight = "0.5rem",
      width = width,
...
```{r Reference Tab, echo = FALSE, warning = FALSE, message = FALSE, results="asis"}
